  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <Sparkles className="w-4 h-4 text-primary-100 mt-2" />
        ...
        >
          هيمنة وكالة تسويق رقمي في الرياض متخصصة في إدارة السوشيال ميديا وصناعة المحتوى والحملات الإعلانية لمساعدة الشركات على
